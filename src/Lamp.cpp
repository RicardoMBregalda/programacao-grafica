...
Lamp::Lamp(glm::vec3 pos, glm::vec3 rot, glm::vec3 scl, float ang)
    : Object(pos, rot, scl, ang) {
    init();
}

Lamp::Lamp(glm::vec3 pos, float ang)
...
void Lamp::init() {
    ...
    // ===== Cúpula (abajur) - múltiplos cilindros formando cone =====
    const int layers = 5;
